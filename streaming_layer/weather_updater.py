...
cities = {"San Juan":{"lat":0,"long":0},
          "Iquitos":{"lat":0,"long":0},
          "Rio de Janeiro":{"lat":0,"long":0},
          "Brasilia":{"lat":0,"long":0},
          "Sao Paulo":{"lat":0,"long":0},
          "Salvador":{"lat":0,"long":0} }
...
while True:
    ...
    for city in cities:
        ...
        try:
            ...
            forecast = forecastio.load_forecast(ds_api_key, coords["lat"], coords["long"], units="si")
            daily = forecast.daily()
            # Get the data for the next seven days
            # Insert into array in the correct format
        except:
            print(str(datetime.now())+": Error gathering weather data for "+ city +"!")

    # Parallelize array
    # Make LabeledPoint RDD out of the array
    # Run prediction
    # Update PostgreSQL table into week starting today
